...
import DateRangeSelector, { parseDateRange, formatDateNL } from '@/components/DateRangeSelector';
...
export default function DashboardsRoute() {
  ...
  useEffect(() => {
    ...
    setActiveDashboardLabel(dashboard?.label ?? '');
  }, [selectedId, setActiveDashboardId, setActiveDashboardLabel]);
