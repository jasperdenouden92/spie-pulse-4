...
export default function Home() {
  ...
  const currentPage = (searchParams.get('page') ?? 'portfolio') as 'home' | 'portfolio' | 'insights' | 'themes' | 'workspaces';
  ...
  const handlePageChange = (page: 'home' | 'portfolio' | 'insights' | 'themes' | 'workspaces') => {
    setLocalQuickviewAsset(null);
