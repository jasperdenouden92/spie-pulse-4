...
export const buildingOperationalStats: Record<string, BuildingOperationalStats> = {
  'Skyline Plaza': {
    ...
    tickets: { count: 12, outstanding: 6813 },
  ...
  'Innovation Hub': {
    ...
    tickets: { count: 8, outstanding: 4250 },
  ...
  'Metro Heights': {
    ...
    tickets: { count: 15, outstanding: 9120 },
  ...
  'Riverside Complex': {
    ...
    tickets: { count: 10, outstanding: 5675 },
  ...
  'Gateway Center': {
    ...
    tickets: { count: 18, outstanding: 11250 },
  ...
  'Harbor View': {
    ...
    tickets: { count: 7, outstanding: 3890 },
  ...
  'Tech District Tower': {
    ...
    tickets: { count: 14, outstanding: 7950 },
  ...
  'Central Plaza': {
    ...
    tickets: { count: 11, outstanding: 6200 },
  ...
  'Harmony Estates': {
    ...
    tickets: { count: 6, outstanding: 3200 },
  ...
  'Atrium Towers': {
    ...
    tickets: { count: 16, outstanding: 10500 },
  ...
  'Civic Center': {
    ...
    comfort: { alerts: 6 },
    assetMonitoring: { alerts: 7 },
    tickets: { count: 9, outstanding: 4800 },
  ...
  'Harbor Point': {
    ...
    comfort: { alerts: 3 },
    assetMonitoring: { alerts: 4 },
    tickets: { count: 6, outstanding: 3400 },
    quotations: { count: 5, due: 2, overdue: 1, totalAmount: 18200 },
  ...
  'Crystal Tower': {
    ...
    comfort: { alerts: 5 },
    assetMonitoring: { alerts: 6 },
    tickets: { count: 10, outstanding: 5500 },
  ...
  'Green Park Office': {
    ...
    tickets: { count: 4, outstanding: 2100 },
  ...
  'Sunset Plaza': {
    ...
    tickets: { count: 20, outstanding: 13200 },
  ...
  'Metro Central': {
    ...
    comfort: { alerts: 4 },
    assetMonitoring: { alerts: 5 },
    tickets: { count: 9, outstanding: 4950 },
  ...
  'North Star': {
    ...
    comfort: { alerts: 1 },
    assetMonitoring: { alerts: 2 },
    tickets: { count: 3, outstanding: 1800 },
  ...
  'Gateway Plaza': {
    ...
    comfort: { alerts: 7 },
    assetMonitoring: { alerts: 8 },
    tickets: { count: 13, outstanding: 7800 },
  ...
  'Tech Park East': {
    ...
    comfort: { alerts: 4 },
    assetMonitoring: { alerts: 5 },
    tickets: { count: 8, outstanding: 4300 },
  ...
  'Crown Heights': {
    ...
    comfort: { alerts: 12 },
    assetMonitoring: { alerts: 15 },
    tickets: { count: 22, outstanding: 14800 },
  ...
  'Liberty Square': {
    ...
    comfort: { alerts: 4 },
    assetMonitoring: { alerts: 5 },
    tickets: { count: 9, outstanding: 5100 },
  ...
  'Pinnacle Tower': {
    ...
    comfort: { alerts: 2 },
    assetMonitoring: { alerts: 3 },
    tickets: { count: 5, outstanding: 2800 },
  ...
  'Heritage Building': {
    ...
    tickets: { count: 24, outstanding: 16500 },
  ...
  'Modern Canvas': {
    ...
    comfort: { alerts: 4 },
    assetMonitoring: { alerts: 5 },
    tickets: { count: 8, outstanding: 4500 },
  ...
  'Velocity Center': {
    ...
    comfort: { alerts: 1 },
    assetMonitoring: { alerts: 2 },
    tickets: { count: 3, outstanding: 1600 },
  ...
  'Zenith Plaza': {
    ...
    comfort: { alerts: 4 },
    assetMonitoring: { alerts: 5 },
    tickets: { count: 9, outstanding: 5200 },
  ...
  'Eclipse Tower': {
    ...
    comfort: { alerts: 6 },
    assetMonitoring: { alerts: 7 },
    tickets: { count: 11, outstanding: 6400 },
  ...
  'Aurora Office': {
    ...
    comfort: { alerts: 5 },
    assetMonitoring: { alerts: 6 },
    tickets: { count: 10, outstanding: 5600 },
  ...
  'Nexus Building': {
    ...
    comfort: { alerts: 3 },
    assetMonitoring: { alerts: 4 },
    tickets: { count: 7, outstanding: 3700 },
  ...
  'Vertex Square': {
    ...
    comfort: { alerts: 9 },
    assetMonitoring: { alerts: 12 },
    tickets: { count: 17, outstanding: 11800 },
  ...
  'Prism Complex': {
    ...
    comfort: { alerts: 2 },
    assetMonitoring: { alerts: 3 },
    tickets: { count: 5, outstanding: 2600 },
