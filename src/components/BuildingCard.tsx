  ...
  return (
    <Card sx={{
      ...
      <CardContent sx={{ p: 2.5 }}>
        ...
        <Box sx={{ position: 'relative', minHeight: showOverall ? 80 : 50 }}>
          ...
          <Box sx={{
            ...
            left: 0,
            right: 0,
            transform: showOverall ? 'translateY(-32px)' : 'translateY(0)',
            transition: 'transform 0.4s cubic-bezier(0.16, 1, 0.3, 1), opacity 0.3s ease',
            opacity: 1,
            zIndex: 1
          }}>
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 0.5 }}>
              <Typography variant="body1" sx={{ fontWeight: 600, transition: 'all 0.3s ease' }}>
                {metricTitle}
              </Typography>
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5, transition: 'all 0.3s ease' }}>
                {metricIcon || <SpeedOutlinedIcon sx={{ fontSize: 24, color: 'text.secondary' }} />}
                <Typography variant="h6" sx={{ fontWeight: 600, transition: 'all 0.3s ease' }}>
                  {performance.green}%
                </Typography>
              </Box>
            </Box>
            <Box sx={{ display: 'flex', height: 12, borderRadius: '2px', overflow: 'hidden', bgcolor: '#f5f5f5', transition: 'all 0.4s cubic-bezier(0.4, 0, 0.2, 1)' }}>
              <Box
                sx={{
                  width: `${performance.green}%`,
                  bgcolor: '#4caf50',
                  borderTop: '3px solid rgba(76, 175, 80, 0.4)',
                  borderBottom: '3px solid rgba(76, 175, 80, 0.4)',
                  transition: 'width 0.5s cubic-bezier(0.4, 0, 0.2, 1)'
                }}
              />
              <Box
                sx={{
                  ...
                  bgcolor: '#ffc107',
                  borderTop: '3px solid rgba(255, 193, 7, 0.4)',
                  borderBottom: '3px solid rgba(255, 193, 7, 0.4)',
                  transition: 'width 0.5s cubic-bezier(0.4, 0, 0.2, 1)'
                }}
              />
              <Box
                sx={{
                  ...
                  bgcolor: '#f44336',
                  borderTop: '3px solid rgba(244, 67, 54, 0.4)',
                  borderBottom: '3px solid rgba(244, 67, 54, 0.4)',
                  transition: 'width 0.5s cubic-bezier(0.4, 0, 0.2, 1)'
                }}
              />
            </Box>
          ...
          <Box sx={{ mt: 2, pt: 2, borderTop: 1, borderColor: 'divider' }}>
            <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 2, justifyContent: 'space-between' }}>
              {operationalStats.map((stat, index) => (
                ...
                >
                  {stat.icon && (
                    <Box sx={{ display: 'flex', alignItems: 'center', color: 'text.secondary', fontSize: 18 }}>
                      {stat.icon}
                    </Box>
                  )}
                  <Box>
                    <Typography variant="caption" sx={{ display: 'block', color: 'text.secondary', fontSize: '0.688rem', lineHeight: 1.3 }}>
                      {stat.label}
                    </Typography>
                    <Typography variant="body2" sx={{ fontWeight: 600, fontSize: '0.938rem', lineHeight: 1.3 }}>
                      {stat.value}
                    </Typography>
                  </Box>
                </Box>
