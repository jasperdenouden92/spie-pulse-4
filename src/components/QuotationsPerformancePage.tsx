          ...
          <Box sx={{ flex: 1, minHeight: 340 }}>
            <LineChart
              ...
              sx={{
                ...
                [`& .${lineClasses.area}`]: {
                  fill: showThresholds ? 'url(#threshold-gradient-quotations)' : undefined,
                  filter: 'none',
            ...
            >
              {showThresholds && (() => {
                ...
                return (
                  <>
                    <ThresholdGradient goodAbove={goodAbove} moderateAbove={modAbove} id="threshold-gradient-quotations" />
                    <ChartsReferenceLine
                      y={goodAbove}
